...
# # Reinforcement Learning : A3C : GoAI
...
class AC_Network():
    def __init__(self,imagesize,s_size,h_size, a_size,scope,trainer):
...
class Worker():
    def __init__(self,game,name,imagesize,s_size,h_size, a_size,trainer,model_path,global_episodes):
